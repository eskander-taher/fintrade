			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
				<div>
					...
					<div className="space-y-6 text-gray-300">
						<p>
							<span className="font-bold text-white">Nestor Limas</span> is a
							professional trader and mentor with over 4 years of trading experience.
							After mastering the markets, he's passed multiple 6-figure prop firm
							challenges and now helps others achieve the same success.
						</p>

						<p>
							Through FinTrade Master Academy, Nestor has helped over 1,200 traders
							transform from gambling-style trading to professional execution. His
							mission is simple: help everyday people stop gambling and start trading
							like pros.
						</p>

						<blockquote className="border-l-4 border-blue-500 pl-4 italic">
							"I didn't come from money. I built this so people like me could trade
