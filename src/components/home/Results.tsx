			...
			<div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 max-w-6xl mx-auto">
				{results.map((result) => (
					<button
						...
						className="relative aspect-[9/16] rounded-xl overflow-hidden border border-gray-800 bg-gray-900/50 backdrop-blur-sm hover:border-blue-500/50 transition-all duration-300 cursor-pointer group"
					>
						<img
							src={result.image}
